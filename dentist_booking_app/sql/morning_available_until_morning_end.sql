-- Morning booking stays open until working_hours.morning_end (or morning capacity).
-- Do NOT subtract allow_before_minutes from morning_end.
-- Evening still uses allow_before_minutes. Shifts remain independent.
...
BEGIN
  ...
  IF p_shift = 'morning' THEN
    ...
    -- Morning stays bookable until morning_end (independent of evening).
    allowed_end := wh.morning_end;
