...
abstract class SnackbarMes {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              isExpanded == true ? const SizedBox.shrink() : const SizedBox(height: 50),
            ],
          ),
        );
      },
  ...
  static Future<void> launchCallPhone({
                      ...
                      Container(
                        ...
                        child: PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return PhotoView(
                              imageProvider: isNetwork ? NetworkImage(path) : FileImage(File(path)),
