      ...
      _$StatusImpl(
        ...
        userRole: freezed == userRole
            ...
            : userRole // ignore: cast_nullable_to_non_nullable
                  as UserRole?,
        typeLogin: freezed == typeLogin
            ? _value.typeLogin
            : typeLogin // ignore: cast_nullable_to_non_nullable
                  as TypeLogin?,
        data: freezed == data
            ? _value.data
...
class _$StatusImpl implements Status {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.typeLogin, typeLogin) ||
  ...
  TResult when<TResult extends Object?>({
    ...
    return status(this.status, userStatus, userRole, typeLogin, data);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return status?.call(this.status, userStatus, userRole, typeLogin, data);
  }
