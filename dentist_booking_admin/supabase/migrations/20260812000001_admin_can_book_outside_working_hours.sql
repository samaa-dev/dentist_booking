-- Admin/staff may create bookings outside working hours, on closed days,
-- and on closed shifts.  Patients keep all existing restrictions.
-- The only change vs the previous version: the admin/staff early-return is
-- moved BEFORE the working-hours / time-window checks.
...
BEGIN
  ...
  -- Admin/staff bypass: skip day-closed, shift-closed, time-window,
  -- booking-disabled, and capacity checks.
