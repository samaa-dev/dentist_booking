-- Auto-confirm: when clinic_settings.auto_confirm is true, create_booking
-- forces booking_status to 'confirmed' (mirrors create_booking_app).
-- When false, uses the caller-provided p_booking_status as before.
