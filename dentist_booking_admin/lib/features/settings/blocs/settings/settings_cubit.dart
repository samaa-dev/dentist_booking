...
import '../../../booking/service/ticket_print_service.dart';
...
class SettingsCubit extends Cubit<SettingsState> {
  ...
  late String? ticketNoteTMP;
  late TextEditingController ticketNoteController;
  ...
  Future<void> init() async {
    try {
      ...
      ticketNoteTMP = config.settings.ticketNote;
      ticketNoteController = TextEditingController(
        text: ticketNoteTMP ?? "",
      );
      _syncTicketNoteToPrintService();
  ...
  void updateTicketNote(String? value) {
    ticketNoteTMP = value?.trim().isEmpty == true ? null : value?.trim();
    _pushTemporaryState();
  }
  ...
  void resetSettings() {
    ...
    ticketNoteTMP = config.settings.ticketNote;
    ticketNoteController.text = ticketNoteTMP ?? "";
    _syncTicketNoteToPrintService();
  ...
  void _syncTicketNoteToPrintService() {
    try {
