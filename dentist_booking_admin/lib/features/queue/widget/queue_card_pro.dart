...
import 'package:dentist_booking_admin/core/routes/routes.dart';
...
import 'queue_card_oro_view.dart';
import 'queue_change_status_form_dialog.dart';
          ...
          statusLoaded: (status) {
            ...
            return QueueCardProView(
              ...
              queueNumber: isNotStarted
                  ? "----"
                  : (status.currentBooking?.queueNumber ?? 0).toString().padLeft(
                      4,
                      '0',
                    ),
