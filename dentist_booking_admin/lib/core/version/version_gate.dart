import 'package:dentist_booking_admin/core/version/app_version_utils.dart';
import 'package:dentist_booking_admin/core/version/update_required_screen.dart';
  ...
  Future<void> _check() async {
    try {
      ...
      setState(() {
        _current = current;
        _minimum =
            minimum?.trim().isNotEmpty == true ? minimum!.trim() : '0.0.0';
        _outdated = outdated;
        _checking = false;
      });
    } catch (e) {
