...
class _$BookingModelImpl implements _BookingModel {
  const _$BookingModelImpl({
    ...
    @JsonKey(name: "patient_type") required this.patientType,
  ...
  @override
  String toString() {
    return 'BookingModel(id: $id, bookingDate: $bookingDate, patientId: $patientId, patientType: $patientType, patientName: $patientName, patientPhone: $patientPhone, patientAddress: $patientAddress, shift: $shift, bookingStatus: $bookingStatus, createdAt: $createdAt, updatedAt: $updatedAt, cancelledAt: $cancelledAt, completedAt: $completedAt, cancelledBy: $cancelledBy, cancelReason: $cancelReason, bookingCreatedBy: $bookingCreatedBy, queueNumber: $queueNumber, ticketCode: $ticketCode, peopleBefore: $peopleBefore)';
  }
...
abstract class _BookingModel implements BookingModel {
  const factory _BookingModel({
    ...
    @JsonKey(name: "patient_type") required final PatientType patientType,
    ...
    @JsonKey(name: 'booking_status') required final BookingStatus bookingStatus,
