...
class _$QueueStatusModelImpl implements _QueueStatusModel {
  const _$QueueStatusModelImpl({
    ...
    @JsonKey(name: 'waiting_count') this.waitingCount,
    this.message,
  });
  ...
  @override
  String toString() {
    return 'QueueStatusModel(state: $state, shift: $shift, currentQueueNumber: $currentQueueNumber, currentBooking: $currentBooking, waitingCount: $waitingCount, message: $message)';
  }
