...
mixin _$ClinicSettingsModel {
  ...
  @JsonKey(name: "min_version_patient")
  String? get minVersionPatient => throw _privateConstructorUsedError;
  @JsonKey(name: "min_version_admin")
  String? get minVersionAdmin => throw _privateConstructorUsedError;
  @JsonKey(name: "min_version_desktop")
  String? get minVersionDesktop => throw _privateConstructorUsedError;
  @JsonKey(name: "min_version_tv")
  String? get minVersionTv => throw _privateConstructorUsedError;
...
abstract class $ClinicSettingsModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(name: "min_version_patient") String? minVersionPatient,
    @JsonKey(name: "min_version_admin") String? minVersionAdmin,
    @JsonKey(name: "min_version_desktop") String? minVersionDesktop,
    @JsonKey(name: "min_version_tv") String? minVersionTv,
  });
}
...
class _$ClinicSettingsModelCopyWithImpl<$Res, $Val extends ClinicSettingsModel>
  ...
  $Res call({
    ...
    Object? minVersionPatient = freezed,
    Object? minVersionAdmin = freezed,
    Object? minVersionDesktop = freezed,
    Object? minVersionTv = freezed,
  }) {
    return _then(
      _value.copyWith(
            ...
            clinicPhone: freezed == clinicPhone
                ...
                : clinicPhone // ignore: cast_nullable_to_non_nullable
                      as String?,
            minVersionPatient: freezed == minVersionPatient
                ? _value.minVersionPatient
                : minVersionPatient // ignore: cast_nullable_to_non_nullable
                      as String?,
            minVersionAdmin: freezed == minVersionAdmin
                ? _value.minVersionAdmin
                : minVersionAdmin // ignore: cast_nullable_to_non_nullable
                      as String?,
            minVersionDesktop: freezed == minVersionDesktop
                ? _value.minVersionDesktop
                : minVersionDesktop // ignore: cast_nullable_to_non_nullable
                      as String?,
            minVersionTv: freezed == minVersionTv
                ? _value.minVersionTv
                : minVersionTv // ignore: cast_nullable_to_non_nullable
                      as String?,
          )
          as $Val,
    );
...
class _$ClinicSetctingsModelImpl implements _ClinicSetctingsModel {
  const _$ClinicSetctingsModelImpl({
    ...
    @JsonKey(name: "min_version_patient") this.minVersionPatient,
    @JsonKey(name: "min_version_admin") this.minVersionAdmin,
    @JsonKey(name: "min_version_desktop") this.minVersionDesktop,
    @JsonKey(name: "min_version_tv") this.minVersionTv,
  });
  ...
  @override
  @JsonKey(name: "min_version_patient")
  final String? minVersionPatient;
  @override
  @JsonKey(name: "min_version_admin")
  final String? minVersionAdmin;
  @override
  @JsonKey(name: "min_version_desktop")
  final String? minVersionDesktop;
  @override
  @JsonKey(name: "min_version_tv")
  final String? minVersionTv;

  @override
  String toString() {
    return 'ClinicSettingsModel(morningCountLimit: $morningCountLimit, eveningCountLimit: $eveningCountLimit, isBookingEnabled: $isBookingEnabled, bookingMorningStartTime: $bookingMorningStartTime, allowBeforeMinutes: $allowBeforeMinutes, autoConfirm: $autoConfirm, updatedAt: $updatedAt, stopReason: $stopReason, clinicPhone: $clinicPhone, minVersionPatient: $minVersionPatient, minVersionAdmin: $minVersionAdmin, minVersionDesktop: $minVersionDesktop, minVersionTv: $minVersionTv)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.minVersionPatient, minVersionPatient) ||
                other.minVersionPatient == minVersionPatient) &&
            (identical(other.minVersionAdmin, minVersionAdmin) ||
                other.minVersionAdmin == minVersionAdmin) &&
            (identical(other.minVersionDesktop, minVersionDesktop) ||
                other.minVersionDesktop == minVersionDesktop) &&
            (identical(other.minVersionTv, minVersionTv) ||
                other.minVersionTv == minVersionTv));
  }
...
abstract class _ClinicSetctingsModel implements ClinicSettingsModel {
  const factory _ClinicSetctingsModel({
    ...
    @JsonKey(name: "min_version_patient") final String? minVersionPatient,
    @JsonKey(name: "min_version_admin") final String? minVersionAdmin,
    @JsonKey(name: "min_version_desktop") final String? minVersionDesktop,
    @JsonKey(name: "min_version_tv") final String? minVersionTv,
  }) = _$ClinicSetctingsModelImpl;
  ...
  @override
  @JsonKey(name: "min_version_patient")
  String? get minVersionPatient;
  @override
  @JsonKey(name: "min_version_admin")
  String? get minVersionAdmin;
  @override
  @JsonKey(name: "min_version_desktop")
  String? get minVersionDesktop;
  @override
  @JsonKey(name: "min_version_tv")
  String? get minVersionTv;
